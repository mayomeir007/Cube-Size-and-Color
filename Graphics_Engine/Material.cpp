...
void Material::SendToShader(const Shader& shader) const
{
	...
	shader.SendData("material.ambient", m_ambient.r, m_ambient.g, m_ambient.b);
	shader.SendData("material.diffuse", m_diffuse.r, m_diffuse.g, m_diffuse.b);
	shader.SendData("material.specular", m_specular.r, m_specular.g, m_specular.b);
}